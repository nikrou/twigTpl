...
class dcLegacy_TokenParser_Block extends Twig_TokenParser
{
  public function parse(Twig_Token $token) {
    ...
    return new dcLegacy_Node_Block($name, $attr, $body, $lineno);
  }

  public function decideBlockEnd($token) {
    return $token->test(dcLegacy_Twigit::DC_END_TAG_BLOCK);
  }

  public function getTag() {
    return dcLegacy_Twigit::DC_TAG_BLOCK;
  }
}